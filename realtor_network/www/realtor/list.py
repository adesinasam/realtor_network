...
def get_context(context):
    ...
    context.realtors = frappe.call('realtor_network.api.get_realtors')

    context.realtor_count = frappe.db.count('Sales Person')
    context.realtor_countactive = frappe.db.count('Sales Person', filters={'enabled': 1})
